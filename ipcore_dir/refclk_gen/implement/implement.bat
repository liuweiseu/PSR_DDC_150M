...
xst -ifn xst.scr
move refclk_gen_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\refclk_gen_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc refclk_gen_exdes.ucf refclk_gen_exdes

echo 'Running map'
map -timing -pr b refclk_gen_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm refclk_gen_exdes -w routed.ncd routed.v
cd ..
