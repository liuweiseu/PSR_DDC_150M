...
xst -ifn xst.scr
move sys_clk_300M_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\sys_clk_300M_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc sys_clk_300M_exdes.ucf sys_clk_300M_exdes

echo 'Running map'
map -timing -pr b sys_clk_300M_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm sys_clk_300M_exdes -w routed.ncd routed.v
cd ..
