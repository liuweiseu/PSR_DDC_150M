...
vlog -work work clk_bus_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clk_bus_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clk_bus_tb work.glbl
